...
`.Fortran`is  admittedly old and does not support Fortran 90/95 *module* declarations either 
...
To be precise: closest point found. You should see *y07weather* to contain the following data frame:
...
The result for SOC dynamics  is in *y07soc* data frame:
 ...
 | ----- | --------- | ----------- | ---------- | ---------  | ----------  | -------- |
 |  Start   |   8.235963  |   0.8|931869  |   0.92987 5   |   9.127769   |   44.40272      |      0   |
